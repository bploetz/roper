module Roper
  module Mongoid
    class JwtIssuerKey
      ...
      field :hmac_secret, type: String
      field :public_key # don't specify type, so we can control the casting in serialize_key
      field :algorithm, type: String
      field :keyid, type: String

      embedded_in :jwt_issuer
